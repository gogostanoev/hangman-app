...
let wrongOne = document.getElementById("wrongOne");
let wrongTwo = document.getElementById("wrongTwo");
let wrongThree = document.getElementById("wrongThree");
let wrongFour = document.getElementById("wrongFour");
let wrongFive = document.getElementById("wrongFive");
let wrongSix = document.getElementById("wrongSix");
let wrongSeven = document.getElementById("wrongSeven");
let wrongEight = document.getElementById("wrongEight");
let wrongNine = document.getElementById("wrongNine");
...
hintButton.addEventListener("click", function(){
    ...
    if((helperOne.toUpperCase() === helperThree.toUpperCase())) return // FIXED A BUG where even after winning you could still get a clue when clicked

    if(wrongGuess === 9) return // FIXED A BUG where even despite losing you could still get a clue when clicked
...
playButton.addEventListener("click", function (){
    ...
    // I set the buttons to a boolean value false, meaning it enables the buttons, you can select all the categories you want
    ...
    gameState.innerHTML = "";
    // displayHangman.innerHTML = ""; // ne gi pokazhuva rabotite
    ...
    // I write .style.display = "none" so it is hidden once you click the play again button as if restarted
    wrongOne.style.display = "none"
    wrongTwo.style.display = "none"
    wrongThree.style.display = "none"
    wrongFour.style.display = "none"
    wrongFive.style.display = "none"
    wrongSix.style.display = "none"
    wrongSeven.style.display = "none"
    wrongEight.style.display = "none"
    wrongNine.style.display = "none"
